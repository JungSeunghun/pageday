...
import styles from './myBookList.module.css';
import Image from 'next/image';

interface MyBookListProps {
  handleSelectBook: (book: { title: string; author: string; image: string }) => void;
}

export default function MyBookList({ handleSelectBook }: MyBookListProps) {
